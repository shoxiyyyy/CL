 class cop_sert {
        ...
        items[] = {
            ...
            { "CSW_FN57_Ballistic_Shield", "FN57 Z Tarcza", 2500, 0, "call life_coplevel >= 3" },
            ...
            { "hlc_rifle_samr2", "", 2500, 0, "call life_coplevel >= 2" },
            { "CSW_M870", "", 2500, 0, "call life_coplevel >= 2" },
            { "hlc_rifle_awmagnum_BL", "", 2500, 0, "call life_coplevel >= 3" },
